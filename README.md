...
**活纸江湖** 是一款基于大语言模型（LLM）的开放世界文字 RPG，采用 **MUD-like 架构**，玩家在 **72×48 网格的单一江湖世界** 中自由探索，与 **19 个拥有独立智能的 NPC** 进行自然语言交互。
...
| 🗺️ **统一江湖地图** | 72×48「青石江湖·万里图」，河道自西北流向东南，裂隙与废墟散布险地 |
...
| 功能 | 说明 |
|------|------|
| **响应式地图** | CSS Grid 72×48 实时渲染，支持点击移动 |
